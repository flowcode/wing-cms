...
CREATE TABLE IF NOT EXISTS `post` (
  ...
  `image_slot` varchar(255) COLLATE latin1_spanish_ci DEFAULT NULL,
  `image_slot_top` varchar(4) COLLATE latin1_spanish_ci NOT NULL,
  `image_slot_left` varchar(4) COLLATE latin1_spanish_ci NOT NULL,
  `image_slot_size` varchar(4) COLLATE latin1_spanish_ci NOT NULL,
